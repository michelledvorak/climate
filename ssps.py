...
class SSPs:
    ...
    def get_SSPs(self):
        ...
        sums_only = SSPs_world['Variable'].str.contains('MAGICC')
        ...
        SSP_119 = SSPs[SSPs['Scenario'].str.contains('ssp119')]

        SSP_126 = SSPs[SSPs['Scenario'].str.contains('ssp126')]

        SSP_245 = SSPs[SSPs['Scenario'].str.contains('ssp245')]

        SSP_370 = SSPs['Scenario'].str.contains('ssp370')
        lowNTCF = SSPs['Scenario'].str.contains('lowNTCF')
        SSP_370 = SSPs[SSP_370][~lowNTCF]
        SSP_370_lowNTCF = SSPs[lowNTCF]
        
        SSP_434 = SSPs[SSPs['Scenario'].str.contains('ssp434')]

        SSP_460 = SSPs[SSPs['Scenario'].str.contains('ssp460')]

        SSP_534_os = SSPs[SSPs['Scenario'].str.contains('ssp534-over')]

        SSP_585 = SSPs[SSPs['Scenario'].str.contains('ssp585')]

        model_list = [SSP_119, SSP_126, SSP_245, SSP_370, SSP_370_lowNTCF, SSP_434, SSP_460, SSP_534_os, SSP_585]
        empty_list = []
        empty_list_2 = []
        ...
        SSP_370_lowNTCF = empty_list[4]
        SSP_434 = empty_list[5]
        SSP_460 = empty_list[6]
        SSP_534_os = empty_list[7]
        SSP_585 = empty_list[8]
        ...
        emissions_370_lowNTCF = np.zeros((nt,40))
        ...
        emissions_370_lowNTCF = empty_list[4]
        emissions_434 = empty_list[5]
        emissions_460 = empty_list[6]
        emissions_534_os = empty_list[7]
        emissions_585 = empty_list[8]

        return emissions_119, emissions_126, emissions_245, emissions_370, emissions_370_lowNTCF, emissions_434, emissions_460, emissions_534_os, emissions_585
